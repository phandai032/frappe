...
${this.frm.doctype_layout.client_script}`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/address_list.html
...
<p><button class="btn btn-xs btn-default btn-address">{{ __("New Address") }}</button></p>`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/contact_list.html
...
<p><button class="btn btn-xs btn-default btn-contact">
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/form_dashboard.html
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/form_footer.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/form_links.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/form_sidebar.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/print_layout.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/report_links.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/set_sharing.html
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/timeline_message_box.html
...
`;
  ...
  // frappe-html:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/form/templates/users_in_sidebar.html
  ...
  function get_version_timeline_content(version_doc, frm) {
    ...
    if (data.changed && data.changed.length) {
      ...
      data.changed.every(function(p) {
        if (p[0] === "docstatus") {
          if (p[2] === 1) {
            let message = updater_reference_link ? get_user_message(version_doc.owner, __("You submitted this document {0}", [updater_reference_link], "Form timeline"), __("{0} submitted this document {1}", [get_user_link(version_doc.owner), updater_reference_link], "Form timeline")) : get_user_message(version_doc.owner, __("You submitted this document", null, "Form timeline"), __("{0} submitted this document", [get_user_link(version_doc.owner)], "Form timeline"));
            out.push(get_version_comment(version_doc, message));
          } else if (p[2] === 2) {
            let message = updater_reference_link ? get_user_message(version_doc.owner, __("You cancelled this document {1}", [updater_reference_link], "Form timeline"), __("{0} cancelled this document {1}", [get_user_link(version_doc.owner), updater_reference_link], "Form timeline")) : get_user_message(version_doc.owner, __("You cancelled this document", null, "Form timeline"), __("{0} cancelled this document", [get_user_link(version_doc.owner)], "Form timeline"));
            out.push(get_version_comment(version_doc, message));
          }
        } else {
      ...
      if (parts.length) {
        let message = updater_reference_link ? get_user_message(version_doc.owner, __("You changed the value of {0} {1}", [
          parts.join(", "),
          ...
          parts.join(", "),
          updater_reference_link
        ])) : get_user_message(version_doc.owner, __("You changed the value of {0}", [parts.join(", ")]), __("{0} changed the value of {1}", [
          get_user_link(version_doc.owner),
          parts.join(", ")
        ]));
        out.push(get_version_comment(version_doc, message));
    ...
    if (data.row_changed && data.row_changed.length) {
      ...
      if (parts2.length) {
        let message = updater_reference_link ? get_user_message(version_doc.owner, __("You changed the values for {0} {1}", [
          parts2.join(", "),
          updater_reference_link
          ...
          parts2.join(", "),
          updater_reference_link
        ])) : get_user_message(version_doc.owner, __("You changed the values for {0}", [parts2.join(", ")]), __("{0} changed the values for {1}", [
          get_user_link(version_doc.owner),
          parts2.join(", ")
        ]));
        out.push(get_version_comment(version_doc, message));
  ...
  var FormTimeline = class extends base_timeline_default {
    ...
    get_creation_message() {
      ...
      return {
        ...
        content: get_user_message(this.frm.doc.owner, __("You created this", null, "Form timeline"), __("{0} created this", [user_link], "Form timeline"))
      };
    }
    get_modified_message() {
      ...
      return {
        ...
        content: get_user_message(this.frm.doc.modified_by, __("You last edited this", null, "Form timeline"), __("{0} last edited this", [user_link], "Form timeline"))
      };
    }
    prepare_timeline_contents() {
    ...
    get_view_timeline_contents() {
      ...
      (this.doc_info.views || []).forEach((view) => {
        ...
        const timeline_content = get_user_message(view.owner, __("You viewed this {0}", [view_time], "Form timeline"), __("{0} viewed this {1}", [user_link, view_time], "Form timeline"));
    ...
    get_attachment_timeline_contents() {
      ...
      (this.doc_info.attachment_logs || []).forEach((attachment_log) => {
        ...
        const timeline_content = is_file_upload ? get_user_message(attachment_log.owner, __("You attached {0}", [filename], "Form timeline"), __("{0} attached {1}", [user_link, filename], "Form timeline")) : get_user_message(attachment_log.owner, __("You removed attachment {0}", [filename], "Form timeline"), __("{0} removed attachment {1}", [user_link, filename], "Form timeline"));
    ...
    get_milestone_timeline_contents() {
      ...
      (this.doc_info.milestones || []).forEach((milestone_log) => {
        ...
        const timeline_content = get_user_message(milestone_log.owner, __("You changed {0} to {1}", [field, value], "Form timeline"), __("{0} changed {1} to {2}", [user_link, field, value], "Form timeline"));
    ...
    get_like_timeline_contents() {
      ...
      (this.doc_info.like_logs || []).forEach((like_log) => {
        const timeline_content = get_user_message(like_log.owner, __("You Liked", null, "Form timeline"), __("{0} Liked", [get_user_link(like_log.owner)], "Form timeline"));
...
//# sourceMappingURL=form.bundle.S7J2XE4H.js.map
