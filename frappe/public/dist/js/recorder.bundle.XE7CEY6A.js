frappe.dom.set_style("/* sfc-style:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/recorder/RecorderDetail.vue?type=style&index=0 */\n.list-row .level-left[data-v-e2a351bd] {\n  flex: 8;\n  width: 100%;\n}\n/*# sourceMappingURL=recorder.bundle.2AGMJSPG.css.map */\n");
(() => {
  ...
  var require_reactivity_cjs = __commonJS({
    "node_modules/@vue/reactivity/dist/reactivity.cjs.js"(exports) {
      ...
      function triggerRef(ref5) {
        triggerRefValue(ref5, ref5.value);
      }
      function unref2(ref5) {
      ...
      _a = "__v_isReadonly";
      function computed4(getterOrOptions, debugOptions, isSSR = false) {
        let getter;
        let setter;
      ...
      exports.shallowRef = shallowRef2;
      exports.stop = stop;
      exports.toRaw = toRaw;
      exports.toRef = toRef;
...
`], ...formatTraceEntry(entry));
          ...
          if (emitsOptions) {
            if (!(event in emitsOptions) && true) {
              if (!propsOptions || !(shared.toHandlerKey(event) in propsOptions)) {
                warn3(`Component emitted event "${event}" but it is neither declared in the emits option nor as an "${shared.toHandlerKey(event)}" prop.`);
              }
            } else {
      ...
      function renderComponentRoot(instance) {
        const { type: Component, vnode, proxy, withProxy, props, propsOptions: [propsOptions], slots, attrs, emit: emit2, render: render4, renderCache, data, setupState, ctx, inheritAttrs } = instance;
        let result;
        ...
        try {
          if (vnode.shapeFlag & 4) {
            ...
            result = normalizeVNode(render4.call(proxyToUse, proxyToUse, renderCache, props, setupState, data, ctx));
            ...
            result = normalizeVNode(render5.length > 1 ? render5(props, true ? {
              get attrs() {
                markAttrsAccessed();
                return attrs;
              },
              slots,
              emit: emit2
            } : { attrs, slots, emit: emit2 }) : render5(props, null));
      ...
      function createInnerComp(comp, { vnode: { ref: ref4, props, children, shapeFlag }, parent }) {
      ...
      var KeepAliveImpl = {
        ...
        setup(props, { slots }) {
          ...
          watch3(() => [props.include, props.exclude], ([include, exclude]) => {
      ...
      function onActivated2(hook, target) {
        registerKeepAliveHook(hook, "a", target);
      }
      function onDeactivated2(hook, target) {
...
If this is a native custom element, make sure to exclude it from component resolution via compilerOptions.isCustomElement.` : ``;
      ...
      function applyOptions(instance) {
        ...
        registerLifecycleHook(onDeactivated2, deactivated);
        ...
        if (render4 && instance.render === shared.NOOP) {
      ...
      function resolveInjections(injectOptions, ctx, checkDuplicateProperties = shared.NOOP, unwrapRef = false) {
        ...
        for (const key in injectOptions) {
          ...
          if (shared.isObject(opt)) {
            if ("default" in opt) {
              injected = inject2(opt.from || key, opt.default, true);
            } else {
              injected = inject2(opt.from || key);
            }
          } else {
      ...
      function resolveMergedOptions(instance) {
        ...
        if (cached) {
          ...
          if (globalMixins.length) {
            globalMixins.forEach((m) => mergeOptions2(resolved, m, optionMergeStrategies, true));
          }
      ...
      function mergeOptions2(to, from, strats, asMixin = false) {
        ...
        if (mixins) {
          mixins.forEach((m) => mergeOptions2(to, m, strats, true));
        }
      ...
      var normalizeSlot2 = (key, rawSlot, ctx) => {
        if (rawSlot._n) {
          return rawSlot;
        }
 ...
 If you want to mount another app on the same host container, you need to unmount the previous app by calling \`app.unmount()\` first.`);
                ...
                {
                  context.reload = () => {
                    render4(cloneVNode(vnode), rootContainer, isSVG);
                  };
                }
...
If you want to remount the same app, move your app creation logic into a factory function and create fresh app instances for each mount - e.g. \`const createMyApp = () => createApp(App)\``);
      ...
      function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
        ...
        if (shared.isFunction(ref4)) {
          callWithErrorHandling(ref4, owner, 12, [value, refs]);
        } else {
          const _isString = shared.isString(ref4);
          const _isRef = reactivity.isRef(ref4);
          if (_isString || _isRef) {
            const doSet = () => {
              if (rawRef.f) {
                ...
                if (isUnmount) {
                  ...
                  if (!shared.isArray(existing)) {
                    if (_isString) {
                      refs[ref4] = [refValue];
                      if (shared.hasOwn(setupState, ref4)) {
                        setupState[ref4] = refs[ref4];
                      }
                    } else {
                      ref4.value = [refValue];
                      if (rawRef.k)
                        refs[rawRef.k] = ref4.value;
                    }
                ...
                warn3("Invalid template ref type:", ref4, `(${typeof ref4})`);
              }
            };
            if (value) {
              doSet.id = -1;
      ...
      function createHydrationFunctions(rendererInternals) {
        ...
        const hydrateNode = (node, vnode, parentComponent, parentSuspense, slotScopeIds, optimized = false) => {
          ...
          const { type, ref: ref4, shapeFlag, patchFlag } = vnode;
...
- Server: ${JSON.stringify(vnode.children)}`);
          ...
          if (ref4 != null) {
            setRef(ref4, null, parentSuspense, vnode);
          }
          return nextNode;
        };
...
- Server rendered DOM:`, node, node.nodeType === 3 ? `(text)` : isComment(node) && node.data === "[" ? `(start of fragment)` : ``);
      ...
      function baseCreateRenderer(options, createHydrationFns) {
        ...
        const patch = (n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, isSVG = false, slotScopeIds = null, optimized = isHmrUpdating ? false : !!n2.dynamicChildren) => {
          ...
          const { type, ref: ref4, shapeFlag } = n2;
          switch (type) {
            case Text:
          ...
          if (ref4 != null && parentComponent) {
            setRef(ref4, n1 && n1.ref, parentSuspense, n2 || n1, !n2);
          }
        };
        ...
        const unmount = (vnode, parentComponent, parentSuspense, doRemove = false, optimized = false) => {
          const { type, props, ref: ref4, children, dynamicChildren, shapeFlag, patchFlag, dirs } = vnode;
          if (ref4 != null) {
            setRef(ref4, null, parentSuspense, vnode, true);
          }
          if (shapeFlag & 256) {
      ...
      var normalizeRef = ({ ref: ref4, ref_key, ref_for }) => {
        return ref4 != null ? shared.isString(ref4) || reactivity.isRef(ref4) || shared.isFunction(ref4) ? { i: currentRenderingInstance, r: ref4, k: ref_key, f: !!ref_for } : ref4 : null;
      };
...
Component that was made reactive: `, type);
      ...
      function cloneVNode(vnode, extraProps, mergeRef = false) {
        const { props, ref: ref4, patchFlag, children } = vnode;
        ...
        const cloned = {
          ...
          ref: extraProps && extraProps.ref ? mergeRef && ref4 ? shared.isArray(ref4) ? ref4.concat(normalizeRef(extraProps)) : [ref4, normalizeRef(extraProps)] : normalizeRef(extraProps) : ref4,
      ...
      function finishComponentSetup(instance, isSSR, skipOptions) {
        ...
        if (!Component.render && instance.render === shared.NOOP && !isSSR) {
          if (!compile2 && Component.template) {
            warn3(`Component provided template option but runtime compilation is not supported in this build of Vue.`);
          } else {
      ...
      function withMemo(memo, render4, cache, index) {
  ...
  var require_runtime_dom_cjs = __commonJS({
    "node_modules/@vue/runtime-dom/dist/runtime-dom.cjs.js"(exports) {
      ...
      var VueElement = class extends BaseClass {
        ...
        _update() {
          render4(this._createVNode(), this.shadowRoot);
        }
        _createVNode() {
...
. If you are returning a value instead of calling "next", make sure to remove the "next" parameter from your function.`;
  ...
  function useLink(props) {
    const router2 = (0, vue_runtime_esm_bundler_exports.inject)(routerKey);
    const currentRoute = (0, vue_runtime_esm_bundler_exports.inject)(routeLocationKey);
    const route = (0, vue_runtime_esm_bundler_exports.computed)(() => router2.resolve((0, vue_runtime_esm_bundler_exports.unref)(props.to)));
    const activeRecordIndex = (0, vue_runtime_esm_bundler_exports.computed)(() => {
    ...
    const isActive = (0, vue_runtime_esm_bundler_exports.computed)(() => activeRecordIndex.value > -1 && includesParams(currentRoute.params, route.value.params));
    const isExactActive = (0, vue_runtime_esm_bundler_exports.computed)(() => activeRecordIndex.value > -1 && activeRecordIndex.value === currentRoute.matched.length - 1 && isSameRouteLocationParams(currentRoute.params, route.value.params));
    function navigate(e = {}) {
      if (guardEvent(e)) {
        return router2[(0, vue_runtime_esm_bundler_exports.unref)(props.replace) ? "replace" : "push"]((0, vue_runtime_esm_bundler_exports.unref)(props.to)).catch(noop);
      }
    ...
    return {
      route,
      href: (0, vue_runtime_esm_bundler_exports.computed)(() => route.value.href),
      isActive,
      isExactActive,
      navigate
    };
  }
  var RouterLinkImpl = /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.defineComponent)({
    name: "RouterLink",
    compatConfig: { MODE: 3 },
    props: {
      to: {
    ...
    useLink,
    setup(props, { slots }) {
      const link = (0, vue_runtime_esm_bundler_exports.reactive)(useLink(props));
      const { options } = (0, vue_runtime_esm_bundler_exports.inject)(routerKey);
      const elClass = (0, vue_runtime_esm_bundler_exports.computed)(() => ({
        [getLinkClass(props.activeClass, options.linkActiveClass, "router-link-active")]: link.isActive,
        [getLinkClass(props.exactActiveClass, options.linkExactActiveClass, "router-link-exact-active")]: link.isExactActive
      }));
      return () => {
        const children = slots.default && slots.default(link);
        return props.custom ? children : (0, vue_runtime_esm_bundler_exports.h)("a", {
  ...
  var RouterViewImpl = /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.defineComponent)({
    name: "RouterView",
    inheritAttrs: false,
    props: {
      name: {
    ...
    setup(props, { attrs, slots }) {
      warnDeprecatedUsage();
      const injectedRoute = (0, vue_runtime_esm_bundler_exports.inject)(routerViewLocationKey);
      const routeToDisplay = (0, vue_runtime_esm_bundler_exports.computed)(() => props.route || injectedRoute.value);
      const injectedDepth = (0, vue_runtime_esm_bundler_exports.inject)(viewDepthKey, 0);
      const depth = (0, vue_runtime_esm_bundler_exports.computed)(() => {
        let initialDepth = (0, vue_runtime_esm_bundler_exports.unref)(injectedDepth);
      ...
      const matchedRouteRef = (0, vue_runtime_esm_bundler_exports.computed)(() => routeToDisplay.value.matched[depth.value]);
      (0, vue_runtime_esm_bundler_exports.provide)(viewDepthKey, (0, vue_runtime_esm_bundler_exports.computed)(() => depth.value + 1));
      (0, vue_runtime_esm_bundler_exports.provide)(matchedRouteKey, matchedRouteRef);
      (0, vue_runtime_esm_bundler_exports.provide)(routerViewLocationKey, routeToDisplay);
      const viewRef = (0, vue_runtime_esm_bundler_exports.ref)();
      (0, vue_runtime_esm_bundler_exports.watch)(() => [viewRef.value, matchedRouteRef.value, props.name], ([instance, to, name], [oldInstance, from, oldName]) => {
        if (to) {
      ...
      return () => {
        ...
        const component = (0, vue_runtime_esm_bundler_exports.h)(ViewComponent, assign({}, routeProps, attrs, {
          onVnodeUnmounted,
          ref: viewRef
        }));
...
<router-view v-slot="{ Component }">
  ...
  function addDevtools(app2, router2, matcher) {
    ...
    setupDevtoolsPlugin({
      ...
      (0, vue_runtime_esm_bundler_exports.watch)(router2.currentRoute, () => {
        refreshRoutesView();
  ...
  function createRouter(options) {
    ...
    const currentRoute = (0, vue_runtime_esm_bundler_exports.shallowRef)(START_LOCATION_NORMALIZED);
...
${JSON.stringify(newTargetLocation, null, 2)}
 when navigating to "${to.fullPath}". A redirect must contain a name or path. This will break in production.`);
    ...
    function handleScroll(to, from, isPush, isFirstNavigation) {
      ...
      return (0, vue_runtime_esm_bundler_exports.nextTick)().then(() => scrollBehavior(to, from, scrollPosition)).then((position) => position && scrollToPosition(position)).catch((err) => triggerError(err, to, from));
    }
    ...
    const router2 = {
      ...
      install(app2) {
        ...
        Object.defineProperty(app2.config.globalProperties, "$route", {
          enumerable: true,
          get: () => (0, vue_runtime_esm_bundler_exports.unref)(currentRoute)
        });
        ...
        for (const key in START_LOCATION_NORMALIZED) {
          reactiveRoute[key] = (0, vue_runtime_esm_bundler_exports.computed)(() => currentRoute.value[key]);
        }
        app2.provide(routerKey, router3);
        app2.provide(routeLocationKey, (0, vue_runtime_esm_bundler_exports.reactive)(reactiveRoute));
  ...
  function useRouter() {
    return (0, vue_runtime_esm_bundler_exports.inject)(routerKey);
  }
  function useRoute() {
    return (0, vue_runtime_esm_bundler_exports.inject)(routeLocationKey);
  }

  // sfc-script:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/recorder/RecorderRoot.vue?type=script
  var RecorderRoot_default = {
    __name: "RecorderRoot",
    setup(__props, { expose }) {
      expose();
      let route = useRoute();
      (0, vue_runtime_esm_bundler_exports.watch)(route, async () => {
        frappe.router.current_route = await frappe.router.parse();
        frappe.breadcrumbs.update();
        frappe.recorder.route = route;
      });
      const __returned__ = { route, watch: vue_runtime_esm_bundler_exports.watch, useRoute };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/recorder/RecorderRoot.vue?type=template
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_router_view = (0, vue_runtime_esm_bundler_exports.resolveComponent)("router-view");
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createBlock)(_component_router_view, null, {
      default: (0, vue_runtime_esm_bundler_exports.withCtx)(({ Component }) => [
        ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createBlock)(vue_runtime_esm_bundler_exports.KeepAlive, null, [
          ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createBlock)((0, vue_runtime_esm_bundler_exports.resolveDynamicComponent)(Component)))
        ], 1024))
      ]),
      _: 1
    });
  ...
  RecorderRoot_default.render = render;
  RecorderRoot_default.__file = "frappe/public/js/frappe/recorder/RecorderRoot.vue";
  var RecorderRoot_default2 = RecorderRoot_default;

  // sfc-script:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/recorder/RecorderDetail.vue?type=script
  var RecorderDetail_default = {
    __name: "RecorderDetail",
    setup(__props, { expose }) {
      expose();
      let router2 = (0, vue_runtime_esm_bundler_exports.ref)(useRouter());
      let requests = (0, vue_runtime_esm_bundler_exports.ref)([]);
      ...
      let query = (0, vue_runtime_esm_bundler_exports.ref)({
        sort: "duration",
        order: "desc",
        filters: {},
        pagination: {
      ...
      let status = (0, vue_runtime_esm_bundler_exports.ref)({
        color: "grey",
        status: "Unknown"
      });
      frappe.recorder.router = router2.value;
      let route = frappe.get_route();
      if (route[2]) {
        router2.value.push({ name: "RequestDetail", params: { id: route[2] } });
      }
      function filtered(reqs) {
        reqs = reqs.slice();
        const filters = Object.entries(query.value.filters);
        reqs = reqs.filter((r) => filters.map((f) => (r[f[0]] || "").match(f[1])).every(Boolean));
      ...
      function route_to_request_detail(request) {
        router2.value.beforeEach(async (to) => {
          if (to.meta.shouldFetch) {
            to.meta.request = await request;
          }
        });
        router2.value.push({ name: "RequestDetail", params: { id: request.uuid } });
      }
      ...
      let pages = (0, vue_runtime_esm_bundler_exports.computed)(() => {
      ...
      const __returned__ = { router: router2, requests, page, columns, query, status, route, filtered, paginated, sorted, refresh, update, clear, start, stop, fetch_status, update_status, update_buttons, route_to_request_detail, export_data, import_data, pages, ref: vue_runtime_esm_bundler_exports.ref, computed: vue_runtime_esm_bundler_exports.computed, onMounted: vue_runtime_esm_bundler_exports.onMounted, useRouter };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/recorder/RecorderDetail.vue?type=template
  var _withScopeId = (n) => ((0, vue_runtime_esm_bundler_exports.pushScopeId)("data-v-e2a351bd"), n = n(), (0, vue_runtime_esm_bundler_exports.popScopeId)(), n);
  var _hoisted_1 = ["onDrop"];
  var _hoisted_2 = { class: "page-form" };
  var _hoisted_3 = { class: "filter-list" };
  var _hoisted_4 = { class: "tag-filters-area" };
  var _hoisted_5 = { class: "active-tag-filters" };
  var _hoisted_6 = { class: "btn btn-default btn-xs add-filter text-muted" };
  var _hoisted_7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", { class: "filter-edit-area" }, null, -1));
  var _hoisted_8 = { class: "sort-selector" };
  var _hoisted_9 = { class: "dropdown" };
  var _hoisted_10 = {
    class: "text-muted dropdown-toggle small",
    "data-toggle": "dropdown"
  };
  var _hoisted_11 = { class: "dropdown-text" };
  var _hoisted_12 = { class: "dropdown-menu" };
  var _hoisted_13 = ["onClick"];
  var _hoisted_14 = { class: "option" };
  var _hoisted_15 = { class: "btn btn-default btn-xs btn-order" };
  var _hoisted_16 = { class: "frappe-list" };
  var _hoisted_17 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", { class: "list-filters" }, null, -1));
  var _hoisted_18 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
    style: { "margin-bottom": "9px" },
    class: "list-toolbar-wrapper hide"
  }, [
    /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
      class: "list-toolbar btn-group",
      style: { "display": "inline-block", "margin-right": "10px" }
    })
  ], -1));
  var _hoisted_19 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", { style: { "clear": "both" } }, null, -1));
  var _hoisted_20 = {
    key: 0,
    class: "result"
  };
  var _hoisted_21 = { class: "list-headers" };
  var _hoisted_22 = { class: "level list-row list-row-head text-muted small" };
  var _hoisted_23 = { class: "level-left list-header-subject" };
  var _hoisted_24 = { class: "list-row-col ellipsis list-subject level" };
  var _hoisted_25 = { class: "level-item" };
  var _hoisted_26 = { class: "level-right" };
  var _hoisted_27 = { class: "list-count" };
  var _hoisted_28 = { class: "result-list" };
  var _hoisted_29 = ["onClick"];
  var _hoisted_30 = { class: "level list-row small" };
  var _hoisted_31 = { class: "level-left ellipsis" };
  var _hoisted_32 = { class: "list-row-col ellipsis list-subject level" };
  var _hoisted_33 = ["title"];
  var _hoisted_34 = { class: "ellipsis text-muted" };
  var _hoisted_35 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", { class: "level-right ellipsis" }, [
    /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", { class: "list-row-col ellipsis list-subject level" }, [
      /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", { class: "level-item ellipsis text-muted" })
    ])
  ], -1));
  var _hoisted_36 = {
    key: 1,
  ...
  var _hoisted_41 = { class: "col-xs-6" };
  var _hoisted_42 = { class: "btn-group btn-group-paging" };
  var _hoisted_43 = ["onClick"];
  var _hoisted_44 = { class: "col-xs-6 text-right" };
  var _hoisted_45 = { class: "btn-group btn-group-paging" };
  ...
  function render2(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
      onDrop: (0, vue_runtime_esm_bundler_exports.withModifiers)($setup.import_data, ["prevent"]),
      onDragover: _cache[2] || (_cache[2] = (0, vue_runtime_esm_bundler_exports.withModifiers)(() => {
      }, ["prevent"]))
    }, [
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_2, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_3, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_4, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_5, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", _hoisted_6, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Add Filter")), 1)
            ])
          ]),
          _hoisted_7,
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_8, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_9, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("a", _hoisted_10, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_11, (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.columns.filter((c) => c.slug == $setup.query.sort)[0].label), 1)
              ]),
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("ul", _hoisted_12, [
                ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.columns.filter((c) => c.sortable), (column, index) => {
                  return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("li", {
                    key: index,
                    onClick: ($event) => $setup.query.sort = column.slug
                  }, [
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("a", _hoisted_14, (0, vue_runtime_esm_bundler_exports.toDisplayString)(column.label), 1)
                  ], 8, _hoisted_13);
                }), 128))
              ])
            ]),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", _hoisted_15, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["octicon text-muted", $setup.query.order == "asc" ? "octicon-arrow-down" : "octicon-arrow-up"]),
      ...
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_16, [
        _hoisted_17,
        _hoisted_18,
        _hoisted_19,
        $setup.requests.length != 0 ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_20, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_21, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("header", _hoisted_22, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_23, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_24, [
                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_25, (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.columns[0].label), 1)
                ]),
                ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.columns.slice(1), (column, index) => {
                  return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
                    class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["list-row-col ellipsis hidden-xs", { "text-right": column.number }]),
                    key: index
                  }, [
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(column.label), 1)
                  ], 2);
                }), 128))
              ]),
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_26, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_27, [
                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(($setup.query.pagination.page - 1) * $setup.query.pagination.limit + 1) + " - " + (0, vue_runtime_esm_bundler_exports.toDisplayString)(Math.min($setup.query.pagination.page * $setup.query.pagination.limit, $setup.requests.length)) + " of " + (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.requests.length), 1)
                ])
              ])
            ])
          ]),
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_28, [
            ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.paginated($setup.sorted($setup.filtered($setup.requests))), (request, index) => {
              return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
                class: "list-row-container",
                key: index,
                onClick: ($event) => $setup.route_to_request_detail(request)
              }, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_30, [
                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_31, [
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_32, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                        class: "level-item bold",
                        title: request[$setup.columns[0].slug]
                      }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(request[$setup.columns[0].slug]), 9, _hoisted_33)
                    ]),
                    ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.columns.slice(1), (column, index2) => {
                      return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
                        class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["list-row-col ellipsis", { "text-right": column.number }]),
                        key: index2
                      }, [
                        (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_34, (0, vue_runtime_esm_bundler_exports.toDisplayString)(request[column.slug]), 1)
                      ], 2);
                    }), 128))
                  ]),
                  _hoisted_35
        ...
        $setup.requests.length == 0 ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_36, [
          $setup.status.status == "Inactive" ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_37, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("p", null, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
                class: "btn btn-primary btn-sm btn-new-doc",
                onClick: _cache[1] || (_cache[1] = ($event) => $setup.start())
              }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Start Recording")), 1)
            ]),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("p", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Recorder is Inactive.")), 1),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("p", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Start recording or drag & drop a previously exported data file to view it.")), 1)
          ])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true),
          $setup.status.status == "Active" ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_38, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("p", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("No Requests found")), 1),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("p", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Go make some noise")), 1)
          ])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
        ])) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_39, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_40, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_41, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_42, [
                ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)([20, 100, 500], (limit, index) => {
                  return (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
                    type: "button",
                    class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["btn btn-default btn-sm", $setup.query.pagination.limit == limit ? "btn-info" : ""]),
                    key: index,
                    onClick: ($event) => $setup.query.pagination.limit = limit
                  }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(limit), 11, _hoisted_43);
                }), 64))
              ])
            ]),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_44, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_45, [
                ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.pages, (page, index) => {
                  return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("button", {
                    type: "button",
                    class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["btn btn-default btn-sm", page.status]),
                    key: index,
                    onClick: ($event) => $setup.query.pagination.page = page.number
                  }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(page.label), 11, _hoisted_46);
                }), 128))
              ])
            ])
          ])
  ...
  RecorderDetail_default.render = render2;
  RecorderDetail_default.__file = "frappe/public/js/frappe/recorder/RecorderDetail.vue";
  RecorderDetail_default.__scopeId = "data-v-e2a351bd";
  var RecorderDetail_default2 = RecorderDetail_default;

  // sfc-script:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/recorder/RequestDetail.vue?type=script
  var RequestDetail_default = {
    __name: "RequestDetail",
    setup(__props, { expose }) {
      expose();
      let route = (0, vue_runtime_esm_bundler_exports.ref)(useRoute());
      let columns = [
      ...
      let group_duplicates = (0, vue_runtime_esm_bundler_exports.ref)(false);
      let showing = (0, vue_runtime_esm_bundler_exports.ref)(null);
      let request = (0, vue_runtime_esm_bundler_exports.ref)({
        calls: []
      });
      ...
      (0, vue_runtime_esm_bundler_exports.onMounted)(async () => {
        ...
        if (req && (req.headers || req.form_dict || req.calls)) {
          ...
          let r = await frappe.call({
            ...
            args: {
              uuid: (req == null ? void 0 : req.uuid) || id
            }
          });
          request.value = r.message;
        }
      });
      const __returned__ = { route, columns, table_columns, query, group_duplicates, showing, request, paginated, sorted, grouped, pages, computed: vue_runtime_esm_bundler_exports.computed, onMounted: vue_runtime_esm_bundler_exports.onMounted, ref: vue_runtime_esm_bundler_exports.ref, useRoute };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/recorder/RequestDetail.vue?type=template
  var _hoisted_110 = { class: "row form-section visible-section shaded-section" };
  var _hoisted_210 = { class: "section-body" };
  var _hoisted_310 = { class: "form-column col-sm-12" };
  var _hoisted_47 = ["data-fieldtype"];
  var _hoisted_52 = { class: "form-group" };
  var _hoisted_62 = { class: "clearfix" };
  var _hoisted_72 = { class: "control-label" };
  var _hoisted_82 = ["innerHTML"];
  var _hoisted_92 = { class: "row form-section visible-section" };
  var _hoisted_102 = { class: "col-sm-10" };
  var _hoisted_112 = { class: "form-section-heading uppercase" };
  var _hoisted_122 = { class: "col-sm-2 filter-list" };
  var _hoisted_132 = { class: "sort-selector" };
  var _hoisted_142 = { class: "dropdown" };
  var _hoisted_152 = {
    class: "text-muted dropdown-toggle small",
    "data-toggle": "dropdown"
  };
  var _hoisted_162 = { class: "dropdown-text" };
  var _hoisted_172 = { class: "dropdown-menu" };
  var _hoisted_182 = ["onClick"];
  var _hoisted_192 = { class: "option" };
  var _hoisted_202 = { class: "section-body" };
  var _hoisted_212 = { class: "form-column col-sm-12" };
  var _hoisted_222 = {
    class: "form-group frappe-control input-max-width",
    "data-fieldtype": "Check"
  };
  var _hoisted_232 = { class: "checkbox" };
  var _hoisted_242 = { class: "input-area" };
  var _hoisted_252 = { class: "label-area small" };
  var _hoisted_262 = {
    class: "frappe-control",
    "data-fieldtype": "Table"
  };
  var _hoisted_272 = { class: "form-grid" };
  var _hoisted_282 = { class: "grid-heading-row" };
  var _hoisted_292 = { class: "grid-row" };
  var _hoisted_302 = { class: "data-row row" };
  var _hoisted_312 = { class: "row-index col col-xs-1" };
  var _hoisted_322 = { class: "col grid-static-col col-xs-6" };
  var _hoisted_332 = { class: "static-area ellipsis" };
  var _hoisted_342 = { class: "col grid-static-col col-xs-2" };
  var _hoisted_352 = { class: "static-area ellipsis text-right" };
  var _hoisted_362 = { class: "col grid-static-col col-xs-2" };
  var _hoisted_372 = { class: "static-area ellipsis text-right" };
  var _hoisted_382 = { class: "grid-body" };
  var _hoisted_392 = { class: "rows" };
  var _hoisted_402 = ["onClick"];
  var _hoisted_412 = { class: "row-index col col-xs-1" };
  var _hoisted_422 = {
    class: "col grid-static-col col-xs-6",
    "data-fieldtype": "Code"
  };
  var _hoisted_432 = { class: "static-area" };
  var _hoisted_442 = { class: "col grid-static-col col-xs-2" };
  var _hoisted_452 = { class: "static-area ellipsis text-right" };
  var _hoisted_462 = { class: "col grid-static-col col-xs-2" };
  var _hoisted_472 = { class: "static-area ellipsis text-right" };
  var _hoisted_48 = { class: "col col-xs-1" };
  var _hoisted_49 = { class: "close btn-open-row" };
  var _hoisted_50 = {
    key: 0,
    class: "recorder-form-in-grid"
  };
  var _hoisted_51 = { class: "toolbar grid-header-toolbar" };
  var _hoisted_522 = { class: "panel-title" };
  var _hoisted_53 = { class: "grid-form-row-index" };
  var _hoisted_54 = { class: "grid-form-body" };
  var _hoisted_55 = { class: "form-area" };
  var _hoisted_56 = { class: "form-layout" };
  var _hoisted_57 = { class: "form-page" };
  var _hoisted_58 = { class: "row form-section visible-section" };
  var _hoisted_59 = { class: "section-body" };
  var _hoisted_60 = { class: "form-column col-sm-12" };
  var _hoisted_61 = { class: "frappe-control" };
  var _hoisted_622 = { class: "form-group" };
  var _hoisted_63 = { class: "clearfix" };
  var _hoisted_64 = { class: "control-label" };
  var _hoisted_65 = { class: "control-value like-disabled-input for-description" };
  var _hoisted_66 = { class: "frappe-control input-max-width" };
  var _hoisted_67 = { class: "form-group" };
  var _hoisted_68 = { class: "clearfix" };
  var _hoisted_69 = { class: "control-label" };
  var _hoisted_70 = { class: "control-value like-disabled-input" };
  var _hoisted_71 = { class: "frappe-control input-max-width" };
  var _hoisted_722 = { class: "form-group" };
  var _hoisted_73 = { class: "clearfix" };
  var _hoisted_74 = { class: "control-label" };
  var _hoisted_75 = { class: "control-value like-disabled-input" };
  var _hoisted_76 = { class: "frappe-control" };
  var _hoisted_77 = { class: "form-group" };
  var _hoisted_78 = { class: "clearfix" };
  var _hoisted_79 = { class: "control-label" };
  var _hoisted_80 = {
    class: "control-value like-disabled-input for-description",
    style: { "overflow": "auto" }
  };
  var _hoisted_81 = { class: "table table-striped" };
  var _hoisted_822 = {
    key: 0,
    class: "frappe-control"
  };
  var _hoisted_83 = { class: "form-group" };
  var _hoisted_84 = { class: "clearfix" };
  var _hoisted_85 = { class: "control-label" };
  var _hoisted_86 = {
    class: "control-value like-disabled-input for-description",
    style: { "overflow": "auto" }
  };
  var _hoisted_87 = { class: "table table-striped" };
  var _hoisted_88 = {
    key: 0,
  ...
  var _hoisted_90 = { class: "row" };
  var _hoisted_91 = { class: "col-xs-6" };
  var _hoisted_922 = { class: "btn-group btn-group-paging" };
  var _hoisted_93 = ["onClick"];
  var _hoisted_94 = { class: "col-xs-6 text-right" };
  var _hoisted_95 = { class: "btn-group btn-group-paging" };
    ...
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", null, [
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_110, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_210, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_310, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("form", null, [
              ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.columns, (column, index) => {
                return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
                  class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["frappe-control", column.class]),
                  ...
                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_52, [
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_62, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("label", _hoisted_72, (0, vue_runtime_esm_bundler_exports.toDisplayString)(column.label), 1)
                    ]),
      ...
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_92, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_102, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("h6", _hoisted_112, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("SQL Queries")), 1)
        ]),
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_122, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_132, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_142, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("a", _hoisted_152, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_162, (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.table_columns.filter((c) => c.slug == $setup.query.sort)[0].label), 1)
              ]),
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("ul", _hoisted_172, [
                ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.table_columns.filter((c) => c.sortable), (column, index) => {
                  return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("li", {
                    key: index,
                    onClick: ($event) => $setup.query.sort = column.slug
                  }, [
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("a", _hoisted_192, (0, vue_runtime_esm_bundler_exports.toDisplayString)(column.label), 1)
                  ], 8, _hoisted_182);
                }), 128))
              ])
            ]),
        ...
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_202, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_212, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("form", null, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_222, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_232, [
                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("label", null, [
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_242, [
                      (0, vue_runtime_esm_bundler_exports.withDirectives)((0, vue_runtime_esm_bundler_exports.createElementVNode)("input", {
                        ...
                        [vue_runtime_esm_bundler_exports.vModelCheckbox, $setup.group_duplicates]
                      ])
                    ]),
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_252, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Group Duplicate Queries")), 1)
                  ])
                ])
              ]),
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_262, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", null, [
                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_272, [
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_282, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_292, [
                        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_302, [
                          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_312, [
                            (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Index")), 1)
                          ]),
                          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_322, [
                            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_332, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Query")), 1)
                          ]),
                          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_342, [
                            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_352, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Duration (ms)")) + '"', 1)
                          ]),
                          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_362, [
                            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_372, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Exact Copies")), 1)
                          ])
                        ])
                      ])
                    ]),
                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_382, [
                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_392, [
                        ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.paginated($setup.sorted($setup.grouped($setup.request.calls))), (call) => {
                          return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", {
                            class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["grid-row", $setup.showing == call.index ? "grid-row-open" : ""]),
                            key: call.index
                          }, [
                            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
                              class: "data-row row",
                              ...
                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_412, [
                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.index), 1)
                              ]),
                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_422, [
                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_432, [
                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.query), 1)
                                ])
                              ]),
                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_442, [
                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_452, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.duration), 1)
                              ]),
                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_462, [
                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_472, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.exact_copies), 1)
                              ]),
                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_48, [
                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("a", _hoisted_49, [
                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                                    class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["octicon", $setup.showing == call.index ? "octicon-triangle-up" : "octicon-triangle-down"])
                                  }, null, 2)
                                ])
                              ])
                            ], 8, _hoisted_402),
                            $setup.showing == call.index ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_50, [
                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", {
                                class: "grid-form-heading",
                                onClick: _cache[2] || (_cache[2] = ($event) => $setup.showing = null)
                              }, [
                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_51, [
                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_522, [
                                    (0, vue_runtime_esm_bundler_exports.createTextVNode)((0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("SQL Query")) + " #", 1),
                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", _hoisted_53, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.index), 1)
                                  ])
                                ])
                              ]),
                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_54, [
                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_55, [
                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_56, [
                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_57, [
                                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_58, [
                                        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_59, [
                                          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_60, [
                                            (0, vue_runtime_esm_bundler_exports.createElementVNode)("form", null, [
                                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_61, [
                                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_622, [
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_63, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("label", _hoisted_64, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Query")), 1)
                                                  ]),
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_65, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("pre", null, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.query), 1)
                                                  ])
                                                ])
                                              ]),
                                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_66, [
                                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_67, [
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_68, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("label", _hoisted_69, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Duration (ms)")) + '"', 1)
                                                  ]),
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_70, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.duration), 1)
                                                ])
                                              ]),
                                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_71, [
                                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_722, [
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_73, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("label", _hoisted_74, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Exact Copies")), 1)
                                                  ]),
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_75, (0, vue_runtime_esm_bundler_exports.toDisplayString)(call.exact_copies), 1)
                                                ])
                                              ]),
                                              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_76, [
                                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_77, [
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_78, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("label", _hoisted_79, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Stack Trace")), 1)
                                                  ]),
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_80, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("table", _hoisted_81, [
                                                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("thead", null, [
                                                        (0, vue_runtime_esm_bundler_exports.createElementVNode)("tr", null, [
                                                          ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)(["filename", "lineno", "function"], (key) => {
                                                            return (0, vue_runtime_esm_bundler_exports.createElementVNode)("th", { key }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(key), 1);
                                                          }), 64))
                                                        ])
                                                      ]),
                                                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("tbody", null, [
                                                        ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)(call.stack, (row, index) => {
                                                          return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("tr", { key: index }, [
                                                            ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)(["filename", "lineno", "function"], (key) => {
                                                              return (0, vue_runtime_esm_bundler_exports.createElementVNode)("td", { key }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(row[key]), 1);
                                                            }), 64))
                                                          ]);
                                                        }), 128))
                                                      ])
                                              ...
                                              call.explain_result[0] ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_822, [
                                                (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_83, [
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_84, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("label", _hoisted_85, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("SQL Explain")), 1)
                                                  ]),
                                                  (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_86, [
                                                    (0, vue_runtime_esm_bundler_exports.createElementVNode)("table", _hoisted_87, [
                                                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("thead", null, [
                                                        (0, vue_runtime_esm_bundler_exports.createElementVNode)("tr", null, [
                                                          ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)(Object.keys(call.explain_result[0]), (key) => {
                                                            return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("th", { key }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(key), 1);
                                                          }), 128))
                                                        ])
                                                      ]),
                                                      (0, vue_runtime_esm_bundler_exports.createElementVNode)("tbody", null, [
                                                        ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)(call.explain_result, (row, index) => {
                                                          return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("tr", { key: index }, [
                                                            ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)(Object.keys(call.explain_result[0]), (key) => {
                                                              return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("td", { key }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(row[key]), 1);
                                                            }), 128))
                                                          ]);
                                                        }), 128))
                                                      ])
                      ...
                      $setup.request.calls.length == 0 ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_88, (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("No Data")), 1)) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
                    ])
                  ])
                ])
              ])
        ...
        $setup.request.calls.length != 0 ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_89, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_90, [
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_91, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_922, [
                ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)([20, 50, 100], (limit, index) => {
                  return (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
                    type: "button",
                    class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["btn btn-default btn-sm", $setup.query.pagination.limit == limit ? "btn-info" : ""]),
                    key: index,
                    onClick: ($event) => $setup.query.pagination.limit = limit
                  }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(limit), 11, _hoisted_93);
                }), 64))
              ])
            ]),
            (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_94, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_95, [
                ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(vue_runtime_esm_bundler_exports.Fragment, null, (0, vue_runtime_esm_bundler_exports.renderList)($setup.pages, (page, index) => {
                  return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("button", {
                    type: "button",
                    class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["btn btn-default btn-sm", page.status]),
                    key: index,
                    onClick: ($event) => $setup.query.pagination.page = page.number
                  }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(page.label), 11, _hoisted_96);
                }), 128))
              ])
            ])
          ])
  ...
  RequestDetail_default.render = render3;
  RequestDetail_default.__file = "frappe/public/js/frappe/recorder/RequestDetail.vue";
  var RequestDetail_default2 = RequestDetail_default;
  ...
  var routes = [
    {
      path: "/detail",
      name: "RecorderDetail",
      component: RecorderDetail_default2
    },
    {
      path: "/request/:id",
      name: "RequestDetail",
      component: RequestDetail_default2,
  ...
  var app = (0, vue_runtime_esm_bundler_exports.createApp)(RecorderRoot_default2).use(router_default);
  SetVueGlobals(app);
...
/*!
  ...
  * @license MIT
  */
//# sourceMappingURL=recorder.bundle.XE7CEY6A.js.map
