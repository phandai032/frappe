frappe.dom.set_style("/* sfc-style:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/build_events/BuildError.vue?type=style&index=0 */\n.build-error-overlay[data-v-fb92787a] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 9999;\n  margin: 0;\n  background: rgba(0, 0, 0, 0.66);\n  --monospace:\n    \"SFMono-Regular\",\n    Consolas,\n    \"Liberation Mono\",\n    Menlo,\n    Courier,\n    monospace;\n  --dim: var(--gray-400);\n}\n.window[data-v-fb92787a] {\n  font-family: var(--monospace);\n  line-height: 1.5;\n  width: 800px;\n  color: #d8d8d8;\n  margin: 30px auto;\n  padding: 25px 40px;\n  position: relative;\n  background: #181818;\n  border-radius: 6px 6px 8px 8px;\n  box-shadow: 0 19px 38px rgba(0, 0, 0, 0.3), 0 15px 12px rgba(0, 0, 0, 0.22);\n  overflow: hidden;\n  border-top: 8px solid var(--red);\n}\npre[data-v-fb92787a] {\n  font-family: var(--monospace);\n  font-size: 13px;\n  margin-top: 0;\n  margin-bottom: 1em;\n  overflow-x: auto;\n  scrollbar-width: none;\n}\ncode[data-v-fb92787a] {\n  font-size: 13px;\n  font-family: var(--monospace);\n  color: var(--yellow);\n}\n.message[data-v-fb92787a] {\n  line-height: 1.3;\n  font-weight: 600;\n  white-space: pre-wrap;\n}\n.frame[data-v-fb92787a] {\n  color: var(--yellow);\n}\n.stack[data-v-fb92787a] {\n  font-size: 13px;\n  color: var(--dim);\n}\n.file-link[data-v-fb92787a] {\n  text-decoration: underline !important;\n  cursor: pointer;\n}\n\n/* sfc-style:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/build_events/BuildSuccess.vue?type=style&index=0 */\n.build-success-message[data-v-fea4fc09] {\n  position: fixed;\n  z-index: 9999;\n  bottom: 0;\n  right: 0;\n  background: rgba(0, 0, 0, 0.6);\n  border-radius: var(--border-radius);\n  padding: 0.5rem 1rem;\n  color: white;\n  font-weight: 500;\n  margin: 1rem;\n}\n/*# sourceMappingURL=build_events.bundle.REWTUKTF.css.map */\n");
(() => {
  ...
  var require_reactivity_cjs = __commonJS({
    "node_modules/@vue/reactivity/dist/reactivity.cjs.js"(exports) {
      ...
      function trackRefValue(ref4) {
        if (shouldTrack && activeEffect) {
          ref4 = toRaw(ref4);
          {
            trackEffects(ref4.dep || (ref4.dep = createDep()), {
              target: ref4,
              type: "get",
              key: "value"
            });
      ...
      function triggerRefValue(ref4, newVal) {
        ref4 = toRaw(ref4);
        if (ref4.dep) {
          {
            triggerEffects(ref4.dep, {
              target: ref4,
              type: "set",
              key: "value",
              newValue: newVal
      ...
      function triggerRef(ref4) {
        triggerRefValue(ref4, ref4.value);
      }
      function unref(ref4) {
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-dom`;
  ...
  // sfc-script:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/build_events/BuildError.vue?type=script
  var BuildError_default = {
    ...
    setup(__props, { expose }) {
      ...
      expose({ show, hide });
      const __returned__ = { data, show, hide, open_in_editor, error_component, ref: vue_runtime_esm_bundler_exports.ref };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/build_events/BuildError.vue?type=template
  var _hoisted_1 = {
    key: 0,
    class: "window"
  };
  ...
  // sfc-script:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/build_events/BuildSuccess.vue?type=script
  var BuildSuccess_default = {
    ...
    setup(__props, { expose }) {
      ...
      expose({ show, hide });
      const __returned__ = { is_shown, live_reload, timeout, show, hide, reload, ref: vue_runtime_esm_bundler_exports.ref };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/home/bench/draerp/apps/frappe/frappe/public/js/frappe/build_events/BuildSuccess.vue?type=template
  var _hoisted_12 = {
    key: 0,
...
//# sourceMappingURL=build_events.bundle.OZ5A25RJ.js.map
