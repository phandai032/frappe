    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_2 = _a.sent();
                    throw new Error("Package \"".concat(module, "\" is required for ").concat(requiredFor, ". Please run \"npm i -D ").concat(module, "\" and try again."));
                case 3: return [2 /*return*/];
            }
        });
    });
...
var AsyncCache = /** @class */ (function () {
    function AsyncCache(enabled) {
        if (enabled === void 0) { enabled = true; }
        this.enabled = enabled;
        this.store = new Map();
    }
    AsyncCache.prototype.get = function (key, fn) {
        var _this = this;
        if (!this.enabled) {
            return fn();
        }
        ...
        if (!val) {
            return fn().then(function (o) { return (_this.store.set(key, o), o); });
        }
        return val;
    };
    return AsyncCache;
